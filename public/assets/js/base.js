...
function AddtoHome(time, once) {
    if (once) {
        var AddHomeStatus = localStorage.getItem("DhagaAddtoHome");
        if (AddHomeStatus === "1" || AddHomeStatus === 1) {
            // already showed up
        }
        else {
            localStorage.setItem("DhagaAddtoHome", 1)
...
//-----------------------------------------------------------------------
// Dark Mode
var checkDarkModeStatus = localStorage.getItem("DhagaDarkmode");
var switchDarkMode = document.querySelectorAll(".dark-mode-switch");
var pageBodyActive = pageBody.classList.contains("dark-mode");

// Check if enable as default
if (Dhaga.Dark_Mode.default) {
    pageBody.classList.add("dark-mode");
}

// Local Dark Mode
if (Dhaga.Dark_Mode.local_mode.enable) {
    var nightStart = Dhaga.Dark_Mode.local_mode.start_time;
    var nightEnd = Dhaga.Dark_Mode.local_mode.end_time;
...
if (Dhaga.Dark_Mode.auto_detect.enable)
...
switchDarkMode.forEach(function (el) {
    el.addEventListener("click", function () {
        var darkmodeCheck = localStorage.getItem("DhagaDarkmode");
        var bodyCheck = pageBody.classList.contains('dark-mode');
        if (darkmodeCheck === 1 || darkmodeCheck === "1" || bodyCheck) {
            pageBody.classList.remove("dark-mode");
            localStorage.setItem("DhagaDarkmode", "0");
            switchDarkModeCheck(false);
        }
        else {
            pageBody.classList.add("dark-mode")
            switchDarkModeCheck(true);
            localStorage.setItem("DhagaDarkmode", "1");
        }
    })
})
//-----------------------------------------------------------------------
...
function testMode() {
    ...
    console.clear();
    console.log("%cDhaga", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #6236FF; padding: 10px 120px; margin-bottom: 16px;")
    ...
    testModeMsg(Dhaga.PWA.enable, "PWA")
    testModeMsg(Dhaga.Dark_Mode.default, "Set dark mode as default theme")
    testModeMsg(Dhaga.Dark_Mode.local_mode.enable, "Local dark mode (between " + Dhaga.Dark_Mode.local_mode.start_time + ":00 and " + Dhaga.Dark_Mode.local_mode.end_time + ":00)")
    testModeMsg(Dhaga.Dark_Mode.auto_detect.enable, "Auto detect dark mode")
    testModeMsg(Dhaga.RTL.enable, "RTL")
    testModeMsg(Dhaga.Test.enable, "Test mode")
    testModeMsg(Dhaga.Test.alert, "Test mode alert")
    ...
    testModeMsg(Dhaga.Animation.goBack, "Go Back")
}
function themeTesting() {
    var word = Dhaga.Test.word;
    var value = "";
